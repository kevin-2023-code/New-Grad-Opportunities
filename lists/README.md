...
> **What the company filters cover.** The sector and headcount of an employer are recorded in a hand-written registry, and it covers 682 of the 987 employers on this list (83% of the roles). An employer it does not cover appears in the main list and in every field, role and location filter exactly as before — it is simply in no company-type filter, because guessing a sector from a company's name is how a reader ends up with the wrong list. [Add one](../CONTRIBUTING.md#adding-a-company-to-the-registry).
...
| :-- | --: | --: |
| [💻 Software Engineering](field/software-engineering.md) | 1,185 | 341 |
| [🤖 Data, AI & Machine Learning](field/data-ai-and-machine-learning.md) | 283 | 138 |
| [🔧 Hardware & Engineering](field/hardware-and-engineering.md) | 345 | 26 |
| [📱 Product & Design](field/product-and-design.md) | 120 | 39 |
| [🧰 IT & Support](field/it-and-support.md) | 114 | 42 |
...
_Between them these 24 filters hold **2,200 of the 2,652** new-grad roles on this list (83%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🏛️ Big Tech](company/big-tech.md) | 579 | 48 | A derived cut, not a hand-picked list: the employer is in one of the technology sectors and the registry records its headcount as 10,000 people or more. An employer the registry does not cover is in no size cut at all. |
...
| [🏗️ Large tech (1,000–9,999)](company/large-tech.md) | 212 | 52 | A derived cut, not a hand-picked list: the employer is in one of the technology sectors and the registry records its headcount as between 1,000 and 9,999 people. An employer the registry does not cover is in no size cut at all. |
| [🚀 Aerospace & defence](company/aerospace-defense.md) | 242 | 15 | Every employer the company registry files under Aerospace & defence, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
...
| [🌱 Startups (under 200)](company/startups.md) | 129 | 53 | A derived cut, not a hand-picked list: the employer is in one of the technology sectors and the registry records its headcount as fewer than 200 people. An employer the registry does not cover is in no size cut at all. |
| [🧾 IT services & consulting](company/it-consulting.md) | 82 | 82 | Every employer the company registry files under IT services & consulting, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
| [🏢 Enterprise & business software](company/enterprise-saas.md) | 96 | 36 | Every employer the company registry files under Enterprise & business software, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
| [🏤 Mid-sized tech (200–999)](company/mid-size-tech.md) | 79 | 27 | A derived cut, not a hand-picked list: the employer is in one of the technology sectors and the registry records its headcount as between 200 and 999 people. An employer the registry does not cover is in no size cut at all. |
...
| [💳 Fintech, payments & crypto](company/fintech.md) | 49 | 30 | Every employer the company registry files under Fintech, payments & crypto, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
| [🏦 Banks, insurers & asset managers](company/banking-finance.md) | 38 | 40 | Every employer the company registry files under Banks, insurers & asset managers, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
...
| [🛒 E-commerce & marketplaces](company/ecommerce-marketplace.md) | 46 | 30 | Every employer the company registry files under E-commerce & marketplaces, at any size. The sector is a fact about the company recorded once, never inferred from a job title. |
...
_Between them these 20 filters hold **1,239 of the 2,652** new-grad roles on this list (47%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._
...
| Filter | The United States & Canada | Elsewhere |
| :-- | --: | --: |
| [Software Engineer](role/software-engineer.md) | 306 | 115 |
| [AI Engineer](role/ai-engineer.md) | 95 | 46 |
...
| [Machine Learning Engineer](role/machine-learning-engineer.md) | 38 | 13 |
| [Full-Stack Engineer](role/full-stack-engineer.md) | 29 | 21 |
| [Data Scientist](role/data-scientist.md) | 29 | 15 |
| [Research Scientist](role/research-scientist.md) | 38 | 4 |
| [Data Analyst](role/data-analyst.md) | 18 | 21 |
| [Platform Engineer](role/platform-engineer.md) | 28 | 11 |
...
_Between them these 33 filters hold **1,631 of the 2,652** new-grad roles on this list (62%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🌉 SF Bay Area](place/bay-area.md) | 539 | 0 | A posting is on this page when its location resolves to a city in this metro AND the row’s country agrees. A posting whose location could not be read is on no location page. Cities on this page, all in CA: San Francisco, South San Francisco, Palo Alto, Menlo Park, Mountain View, Sunnyvale, Cupertino, Santa Clara, San Jose, Redwood City, Foster City, Milpitas, and 24 more. |
...
| [🎸 Austin](place/austin.md) | 168 | 0 | A posting is on this page when its location resolves to a city in this metro AND the row’s country agrees. A posting whose location could not be read is on no location page. Cities on this page, all in TX: Austin, Pflugerville, Round Rock, Cedar Park, Bastrop, Georgetown. |
...
| [🍁 Toronto, Waterloo & Ottawa](place/toronto.md) | 72 | 0 | A posting is on this page when its location resolves to a city in this metro AND the row’s country agrees. A posting whose location could not be read is on no location page. Cities on this page, all in ON: Toronto, Mississauga, Kitchener, Brampton, Waterloo, Ottawa, Markham, Hamilton, London. |
...
_Between them these 2 filters hold **813 of the 2,652** new-grad roles on this list (31%). The rest carry no classification this group can file them under, so they are on the main list and on no page here._

| Filter | The United States & Canada | Elsewhere | What it selects |
| :-- | --: | --: | :-- |
| [🆕 Posted in the last 7 days](new-this-week.md) | 452 | 120 | Published or re-posted within 7 days of the last run. A posting with no date is not here: undated is not recent. |
| [🌐 Remote](remote.md) | 183 | 93 | The catalog’s own work-mode classification, not a keyword match on the title. Hybrid postings are not here — they are a different answer to "must I move?". |
